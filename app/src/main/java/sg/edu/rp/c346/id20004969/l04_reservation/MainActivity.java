package sg.edu.rp.c346.id20004969.l04_reservation;
        ...
        reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {   String message = "";
                    ...
                    if(baby.isChecked())
                    { message += "You have selected an baby seat " + "\n";
                    }
                    else {
                        message += "You not have selected any baby seats " + "\n";
                    }
